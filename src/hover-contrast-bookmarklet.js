...
function simulateMouseover(el) {
	...
	if ( canceled ) {
		...
		var fontbold = parseInt( getComputedStyle( el ).fontWeight );
		var isLargeFont = ( fontbold > 600 && fontsize > 18.75 || fontbold < 600 && fontsize > 24 ) ? true : false;
		var compare = ( isLargeFont ) ? 3.0 : 4.5;
		if ( ratio < compare ) {
